...
namespace CT_Phone_Valid_Worker
{
    public partial class Form1 : Form
    {
        ...
        //sql tables
        string dataTable = "[dbo].[AllWorkers.CTPhoneValid_Data]";
        string doneDataTable = "[dbo].[AllWorkers.CTPhoneValid_Done]";
                ...
                using (selectCMD = new SqlCommand(selectSQL, cnSQL))
                {
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        while (dr.Read())
                        {
                            ...
                            txtPhone.Text = dr["PhoneOne"].ToString();
                        }
                    }
        ...
        void StoreToDoneTable()
        {
            ...
            (DebtorNumber, PhoneOne, WorkerTimestamp, CurrentUser)
            VALUES (@DebtorNumber, @PhoneOne, WorkerTimestamp, CurrentUser)";
            ...
            using (cnSQL = new SqlConnection(sqlConnStr))
            {
                ...
                {
                    insertCMD.Parameters.Add("@DebtorNumber", SqlDbType.VarChar).Value = txtDebtor.Text;
                    insertCMD.Parameters.Add("@PhoneOne", SqlDbType.VarChar).Value = txtPhone.Text;
